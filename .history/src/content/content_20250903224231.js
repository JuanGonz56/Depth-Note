// Content script with bigger, more visible popup
...
function createAnnotationMarker(x, y) {
  ...
  marker.innerHTML = `
    ...
    <div class="annotation-popup" style="
      ...
      border-radius: 12px;
      padding: 20px;
      box-shadow: 0 8px 24px rgba(26, 66, 104, 1);
      z-index: 10001;
      display: block;
      font-family: Arial, sans-serif;
    ">
...
function setupAnnotationEvents(marker) {
  ...
  saveBtn.addEventListener('click', function(e) {
    ...
    if (text) {
      // Change dot to green with message icon
  ...
  cancelBtn.addEventListener('click', function(e) {
    e.stopPropagation();
    // If no text was saved, remove the annotation completely
